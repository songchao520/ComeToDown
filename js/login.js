...
layui.config({
	...
	$("#login").click(function(){
		...
		$.post(cometodown_url+"/loginAdmin",{adminLoginname:loginname,adminPasswrod:loginpassword},function(data){
			if(data.result != "error"){
				
				setCookie("cometodown_username",loginname);
				setCookie("cometodown_loginId",data.loginId)
				
				sessionStorage.setItem("cometodown_loginuser",JSON.stringify(data.data[0]));
				location = "index.html";
