layui.config({
	...
	$("body").on("click",".showPageConfig",function(){  //查看权限
		var _this = $(this);
	...
	function renderDate(data,curr){
		...
		if(currData.length != 0){
			for(var i=0;i<currData.length;i++){
		    	...
		    	+  '<td>'+currData[i].usertypeName+'</td>'
		    	+  '<td>'
		    	+    '<a class="layui-btn layui-btn-success layui-btn-mini showPageConfig" data-id="'+currData[i].recid+'" uname="'+currData[i].usertypeName+'">查看权限</a>'
