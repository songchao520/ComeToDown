layui.config({
	...
	form.on('checkbox(allChoose)', function(data){
		...
		child.each(function(index, item){
			...
			if(item.checked){
				if(!checked){
					$.post(cometodown_url+"/savePageManage",{loginId:cometodown_loginId,usertyperecid:msg,pageid:recid},function(datas){
						if(datas != "wdl"){
							layer.msg("修改成功");
						}else{
							alertLoginMsg()
				...
				if(checked){
					$.post(cometodown_url+"/deletePageManage",{loginId:cometodown_loginId,usertyperecid:msg,pageid:recid},function(datas){
						if(datas != "wdl"){
							layer.msg("修改成功");
						}else{
							alertLoginMsg()
	...
	function getPageData(){
		$.post(cometodown_url+"/getPagesByUser",{loginId:cometodown_loginId,usertyperecid:msg},function(data){
			if(data != "wdl"){
					$.post(cometodown_url+"/getPageConfig",{loginId:cometodown_loginId,usertyperecid:msg},function(datas){
